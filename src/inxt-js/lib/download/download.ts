...
export function download(config: EnvironmentConfig, bucketId: string, fileId: string, progress: DownloadProgressCallback, debug: Logger, state: ActionState): Promise<void> {
